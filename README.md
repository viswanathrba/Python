...
Dictionary
----------
Dictionary is an unordered collection of key-value pairs. Key and value can be of any type.Keys are unique within a dictionary while values may not be.  
The values of a dictionary can be of any type, but the keys must be of an immutable data type such as strings, numbers, or tuples. {Key: Value}  
